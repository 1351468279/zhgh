...
// 定义民族数据源
export const nationsData = ref<DataType>([
    { value: '汉族', text: '汉族' },
    { value: '蒙古族', text: '蒙古族' },
    { value: '回族', text: '回族' },
    { value: '藏族', text: '藏族' },
...
// 定义学位数据源
export const educationsData = ref<DataType>([{
    text: '博士',
    value: '博士'
}, {
    text: '硕士',
...
// 定义学历数据源
export const degreesData = ref<DataType>([{
    text: '博士',
    value: '博士'
}, {
    text: '硕士',
...
// 定义政治面貌数据源
export const politicsData = ref<DataType>([
    {
        text: '中共党员',
        value: '中共党员'
    }, {
