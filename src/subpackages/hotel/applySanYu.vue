...
import { nationsData, educationsData, politicsData, degreesData } from '@/composible/data'
  ...
  <view class="sanYuBox">
    ...
    <uni-forms :model="baseFormData" validateTrigger="blur" :rules="rules" label-width="80px" ref="customForm">
      ...
      <uni-forms-item required label="职位" :name="rulesName.title">
        <uni-easyinput v-model="baseFormData.title" type="text" placeholder="请输入职位" />
      </uni-forms-item>
      <uni-forms-item required label="职务" :name="rulesName.duties">
        <uni-easyinput v-model="baseFormData.duties" type="text" placeholder="请输入职务" />
      </uni-forms-item>
